...
router.post(
  "/:userid/collections",
  passport.authenticate("jwt", { session: false }),
  promiseResolver(CollectionController.createNewCollection),
  responseSender
)
...
router.get(
  "/:userid/collections",
  passport.authenticate("jwt", { session: false }),
  promiseResolver(CollectionController.readAllUserCollections),
  responseSender
)

router.get(
  "/:userid/collections/recent-collection",
  passport.authenticate("jwt", { session: false }),
...
router.get(
  "/:userid/collections/search/:searchText",
  passport.authenticate("jwt", { session: false }),
